...
export default function CardTailwindImage() {
  ...
  <div className="md:flex">
    ...
    <div className="p-8">
      <div className="uppercase tracking-wide text-sm text-indigo-500 font-semibold">Corporate Getaways</div>
      <a href="#" class="block mt-1 text-lg leading-tight font-medium text-black hover:underline">Unparalleled Lodging Options for Your Team</a>
